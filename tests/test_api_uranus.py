"""Tests for the Uranus position calculation service."""
...
class TestUranusPositionBasic:
    """Basic Uranus position calculation tests."""

    def test_uranus_position_basic(self):
        """Test basic Uranus position calculation with valid inputs."""
    ...
    def test_uranus_position_at_equator(self):
        """Test Uranus position at equator."""
        result = calculate_uranus_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_uranus_position_new_york(self):
        """Test Uranus position for New York City."""
        result = calculate_uranus_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
            LocationModel(latitude=40.7128, longitude=-74.0060, elevation=10.0)
        )
    ...
    def test_uranus_position_sydney(self):
        """Test Uranus position for Sydney, Australia (southern hemisphere)."""
        result = calculate_uranus_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_uranus_position_north_pole(self):
        """Test Uranus position at North Pole."""
        result = calculate_uranus_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_uranus_position_south_pole(self):
        """Test Uranus position at South Pole."""
        result = calculate_uranus_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
            LocationModel(latitude=-90.0, longitude=0.0, elevation=0.0)
        )
    ...
    def test_uranus_position_tokyo(self):
        """Test Uranus position in Tokyo."""
        result = calculate_uranus_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_uranus_position_london(self):
        """Test Uranus position in London."""
        result = calculate_uranus_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
...
class TestUranusRetrogradeStatus:
    """Tests for Uranus retrograde motion detection."""

    def test_uranus_retrograde_status_valid(self):
        """Test that Uranus retrograde status is valid."""
        result = calculate_uranus_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_uranus_retrograde_status_consistency(self):
...
class TestUranusPositionValidation:
    ...
    def test_uranus_position_invalid_longitude_high(self):
    ...
    def test_uranus_position_invalid_longitude_low(self):
        """Test that longitude < -180 raises ValueError."""
        with pytest.raises(ValueError, match="longitude"):
            calculate_uranus_position(
                ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_uranus_position_valid_boundary_latitude_positive(self):
    ...
    def test_uranus_position_valid_boundary_latitude_negative(self):
        """Test that latitude = -90 is valid."""
        result = calculate_uranus_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
            LocationModel(latitude=-90.0, longitude=0.0, elevation=0.0)
    ...
    def test_uranus_position_valid_boundary_longitude_positive(self):
    ...
    def test_uranus_position_valid_boundary_longitude_negative(self):
        """Test that longitude = -180 is valid."""
        result = calculate_uranus_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
            LocationModel(latitude=0.0, longitude=-180.0, elevation=0.0)
...
class TestUranusPositionAltitude:
    """Tests for altitude calculations."""

    def test_uranus_altitude_above_horizon(self):
    ...
    def test_uranus_altitude_below_horizon(self):
    ...
    def test_uranus_altitude_at_zenith(self):
...
class TestUranusCoordinates:
    """Tests for RA/Dec coordinates."""

    def test_uranus_ra_dec_valid_range(self):
