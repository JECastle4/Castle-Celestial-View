"""Tests for the Saturn position calculation service."""
...
class TestSaturnPositionBasic:
    """Basic Saturn position calculation tests."""

    def test_saturn_position_basic(self):
        """Test basic Saturn position calculation with valid inputs."""
    ...
    def test_saturn_position_at_equator(self):
        """Test Saturn position at equator."""
        result = calculate_saturn_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_saturn_position_new_york(self):
        """Test Saturn position for New York City."""
        result = calculate_saturn_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
            LocationModel(latitude=40.7128, longitude=-74.0060, elevation=10.0)
        )
    ...
    def test_saturn_position_sydney(self):
        """Test Saturn position for Sydney, Australia (southern hemisphere)."""
        result = calculate_saturn_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_saturn_position_north_pole(self):
        """Test Saturn position at North Pole."""
        result = calculate_saturn_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_saturn_position_south_pole(self):
        """Test Saturn position at South Pole."""
        result = calculate_saturn_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
            LocationModel(latitude=-90.0, longitude=0.0, elevation=0.0)
        )
    ...
    def test_saturn_position_tokyo(self):
        """Test Saturn position in Tokyo."""
        result = calculate_saturn_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_saturn_position_london(self):
        """Test Saturn position in London."""
        result = calculate_saturn_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
...
class TestSaturnRetrogradeStatus:
    """Tests for Saturn retrograde motion detection."""

    def test_saturn_retrograde_status_valid(self):
        """Test that Saturn retrograde status is valid."""
        result = calculate_saturn_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_saturn_retrograde_status_consistency(self):
...
class TestSaturnPositionValidation:
    ...
    def test_saturn_position_invalid_longitude_high(self):
    ...
    def test_saturn_position_invalid_longitude_low(self):
        """Test that longitude < -180 raises ValueError."""
        with pytest.raises(ValueError, match="longitude"):
            calculate_saturn_position(
                ObservationDateTime(date="2026-06-18", time="12:00:00"),
    ...
    def test_saturn_position_valid_boundary_latitude_positive(self):
    ...
    def test_saturn_position_valid_boundary_latitude_negative(self):
        """Test that latitude = -90 is valid."""
        result = calculate_saturn_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
            LocationModel(latitude=-90.0, longitude=0.0, elevation=0.0)
    ...
    def test_saturn_position_valid_boundary_longitude_positive(self):
    ...
    def test_saturn_position_valid_boundary_longitude_negative(self):
        """Test that longitude = -180 is valid."""
        result = calculate_saturn_position(
            ObservationDateTime(date="2026-06-18", time="12:00:00"),
            LocationModel(latitude=0.0, longitude=-180.0, elevation=0.0)
...
class TestSaturnPositionAltitude:
    """Tests for altitude calculations."""

    def test_saturn_altitude_above_horizon(self):
    ...
    def test_saturn_altitude_below_horizon(self):
    ...
    def test_saturn_altitude_at_zenith(self):
...
class TestSaturnCoordinates:
    """Tests for RA/Dec coordinates."""

    def test_saturn_ra_dec_valid_range(self):
